...
# ==============================================================================
# 七、深度選股引擎核心數據解析函數 (快取防護型：完美放寬為任意 3 指標符合)
# ==============================================================================
@st.cache_data(ttl=86400)
def fetch_all_taiwan_stock_pool():
    """動態撈取全台股上市櫃 1800 檔公司代號清單"""
    try:
...
@st.cache_data(ttl=28800)  # 快取保留 8 小時，防止重複抓取卡死 API
...
# ==============================================================================
# 九、多維度決策分頁三合一完美融合佈局 (完完整整補齊觀測站三選股終端分頁)
# ==============================================================================
